...
visions attract more diverse believers. Recent evidence that evaluator
disagreement predicts startup success [@gius2025disagreement] supports
this logic: cognitive diversity in governance enables adaptation.
Neither theory alone predicts the funding-flexibility relationship;
their synthesis does.
...
The cage forms through a four-step sequence. I extend
@vandensteen2010interpersonal's [-@vandensteen2010interpersonal] sorting
equilibrium---originally developed for employee-manager matching within
firms---to the investor-founder context
(Figure [1.1](#fig:sorting-mechanism){reference-type="ref"
...
**Hypothesis 1 (Commitment Cage):** *Early-stage funding correlates negatively with
repositioning.*
...
Building on Levinthal and March's [-@levinthal1993myopia] insight that
...
**Hypothesis 2 (Flexibility Flex):** *Strategic repositioning correlates positively with
later-stage growth.*
...
**Hypothesis 3 (Funding-Growth Paradox):** *Early-stage funding correlates negatively with
