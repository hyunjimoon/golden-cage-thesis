# M5: Empirics (Testing dM/dE < 0)

**¶40-48 | Validates Funding Suppresses Movement | 9¶**

---

**¶40** I now test whether funding suppresses strategic movement. The null hypothesis from Camuffo-Nanda: if funding enables experimentation, then dM/dE ≥ 0. My alternative: commitment dominates experimentation, so dM/dE < 0.
...
**¶44** Mechanism test: I interact funding with proxies for commitment intensity. The dM/dE < 0 effect is 2× stronger for ventures with (a) single lead investors vs. syndicates, (b) milestone-heavy vs. flexible term sheets, (c) high founder-investor belief alignment.

**¶45** Timing matters. Early-stage funding (Seed, Series A) shows stronger dM/dE < 0. Early commitment locks trajectory before enough experimentation accumulates.
