...
version: synthesized_final_v2 (claude+gemini+chatgpt+deepseek feedback)
---
\hypertarget{ch:theory}{%
\chapter{Theory: The Golden Cage}\label{ch:theory}}
...
The ``Golden Cage'' is not a result of moral hazard or founder incompetence; it is a structural inevitability of the funding process. This section explains \textbf{how funding suppresses flexibility} through a specific sequence of belief sorting and signal loss.

\subsection{The Sorting Mechanism}
...
Empirical preview (Chapter~\ref{ch:results}): $\rho(E,R) = -0.087^{***}$ ($N = 180{,}994$).

%% ============================================================
\hypertarget{sec:flexibility-flex}{%
\section{Flexibility Flex}\label{sec:flexibility-flex}}

If the Commitment Cage explains why ventures get stuck, the Flexibility Flex explains \textbf{why getting stuck is fatal}. This section establishes that when ventures preserve flexibility, they can reposition in response to uncertainty---and this repositioning predicts success.
...
\subsection{Theorem 1: When Learning Ceases}

Building on \citeauthor{levinthal1993the}'s \citeyearpar{levinthal1993the} insight that successful organizations become ``myopic'' through competency traps, I formalize the boundary condition where the cage snaps shut.
...
\section{Conclusion: The Paradox}\label{sec:conclusion-hypotheses}}

The Golden Cage theory synthesizes two established theories into a unified mechanism: Van den Steen's sorting equilibrium explains \emph{who} joins (homogenization), and Eisenberg's strategic ambiguity explains \emph{how many} join (coalition diversity).
