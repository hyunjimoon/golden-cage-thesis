...
The \textbf{Flexibility Premium} (dG/dR \textgreater{} 0) captures the growth benefit of adaptation: ventures that reposition (``Movers'') outperform those that hold position (``Stayers'') by 2.60\ensuremath{\times} (18.1\% vs.~7.0\% later-stage survival). The \textbf{Commitment Trap} (dR/dE \textless{} 0) captures the rigidity cost of funding: early funding correlates with lower repositioning (\ensuremath{\rho} = -0.087, p \textless{} 0.001), because governance structures attached to capital constrain adaptation. A positive times a negative is negative: funding correlates with reduced mobility. Not because capital is harmful---but because commitment attracts like-minded investors who filter out skeptics.
