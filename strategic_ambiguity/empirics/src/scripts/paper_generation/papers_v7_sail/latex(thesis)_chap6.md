...
For founders facing uncertainty, the prescription is counterintuitive: commit to the capacity to reposition, not to any particular position. Build governance that can challenge your assumptions. Design for adaptation before funding eliminates the skeptics who make adaptation possible. \textbf{Move to grow.}