...
$\sim$`<!-- -->`{=html}3$\times$ growth multiples; the Stayer achieved
...
**Repositioning (R).** Repositioning magnitude measures the absolute
change in strategic breadth: $R_i = |B_T - B_0|$, where $B_0$ is breadth
at baseline (2021) and $B_T$ at endpoint (2025). Importantly, most
ventures do not reposition at all: 61.2% show R = 0 (I call these
"Stayers"), while only 38.8% show R \> 0 ("Movers"). This pattern (most
