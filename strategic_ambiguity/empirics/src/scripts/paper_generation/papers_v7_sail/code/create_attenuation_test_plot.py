...
def create_visualization(results):
    ...
    for idx, (metric, label) in enumerate(zip(metrics, metric_labels)):
        ...
        # Color: black for restricted, gray for scenarios
        bar_colors = [COLORS['black']] + [COLORS['gray']] * 3

        bars = ax.bar(x, all_vals, color=bar_colors, edgecolor=COLORS['black'], linewidth=1.5)
        ...
        verdict_color = COLORS['black'] if verdict == 'REJECTED' else COLORS['cage']
