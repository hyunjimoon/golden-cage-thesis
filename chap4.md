...
I test three hypotheses. First, the **Commitment Cage** (H1): does funding suppress
repositioning? Second, the **Flexibility Flex** (H2): does repositioning predict success?
Third, the **Funding-Growth Paradox** (H3): does early funding correlate negatively with later
...
correlation $\rho(E,G)$ (bars show correlation by industry; <span
...
The evidence supports all three hypotheses. The **Commitment Cage** (H1) is confirmed:
funding suppresses repositioning ($\rho = -0.133$\*\*\*). The **Flexibility Flex** (H2) is
confirmed: Movers achieve 2.60$\times$ higher success rates than Stayers
(17.6% vs 6.7%). The **Funding-Growth Paradox** (H3) is confirmed: early funding correlates
