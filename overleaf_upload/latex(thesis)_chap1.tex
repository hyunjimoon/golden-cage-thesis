...
\caption{The Funding-Growth Paradox at Two Levels. (A) Individual firms show weak negative correlation ($\rho = -0.04$, $N = 168{,}011$); high variance obscures the signal. (B) Industry means reveal an ecological pattern: capital-intensive sectors show lower success rates. Quantum is the exception---in pre-paradigmatic sectors, capital enables rather than constrains.}\label{fig:capital-paradox}
}
\end{figure}
