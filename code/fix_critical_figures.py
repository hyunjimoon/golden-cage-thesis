...
try:
    ...
    # Fallback colors - Option 2: Blue for Q1-Q3, Red for Q4 (Cage)
    COLORS = {
        'paradox': '#28A745', 'paradox_dark': '#28A745', 'paradox_light': '#90EE90',
        'cage': '#E53935', 'flex': '#4A90D9',  # Option 2: Blue=Flex, Red=Cage
        'text_dark': '#2D2926', 'text_mid': '#5C5652', 'text_light': '#8A847D',
        'bar_primary': '#4A90D9', 'bg_white': '#FFFFFF', 'quantum': '#28A745',
    }
...
def fix_ch4_fig2():
    ...
    # Data - Transportation → Mobility
    industries = ['Quantum', 'Software', 'MedTech', 'Pharma', 'Mobility', 'Hardware']
    ...
    # Add correlation values as labels (LARGER FONTS)
    ...
    # Add sample sizes on far right (LARGER FONTS)
    ...
    ax.set_yticks(y_pos)
    ax.set_yticklabels(industries, fontsize=14)
    ax.set_xlabel('Correlation ρ(E, G)', fontsize=14, color=COLORS['text_mid'])
    ...
    # Title and annotations removed for simplicity (no overlap, no redundancy)
    ...
    # Also save to golden-cage-thesis img folder
    plt.savefig('/Users/hyunjimoon/golden-cage-thesis/img/Ch4_Fig2_industry_rho.png',
                dpi=300, facecolor='white', bbox_inches='tight')
    plt.savefig('/Users/hyunjimoon/golden-cage-thesis/overleaf_upload/img/Ch4_Fig2_industry_rho.png',
                dpi=300, facecolor='white', bbox_inches='tight')
...
def fix_ch1_fig1():
    ...
    # Panel A: Success Rate - Gray for Q1-Q3, Red for Q4 (focus on cage)
    colors_a = ['#9E9E9E', '#9E9E9E', '#9E9E9E', COLORS['cage']]
    ...
    ax1.set_ylabel('Success Rate (%)', fontsize=11, color=COLORS['text_mid'])
    ax1.set_ylim(0, 20)
    ax1.set_title('A. Success Rate by Funding', fontsize=11,
                  fontweight='bold', color=COLORS['text_dark'], pad=10)
    ax1.spines['top'].set_visible(False)
    ax1.spines['right'].set_visible(False)

    # Panel B: Repositioning Rate - Gray for Q1-Q3, Red for Q4 (focus on cage)
    colors_b = ['#9E9E9E', '#9E9E9E', '#9E9E9E', COLORS['cage']]
    ...
    ax2.set_ylim(0, 60)
    ax2.set_title('B. Repositioning Rate by Funding', fontsize=11,
                  fontweight='bold', color=COLORS['text_dark'], pad=10)
    ax2.spines['top'].set_visible(False)
    ax2.spines['right'].set_visible(False)

    plt.tight_layout()
    output_path = f'{IMG_DIR}/Ch1_Fig1_funding_paradox.png'
    plt.savefig(output_path, dpi=300, facecolor='white', bbox_inches='tight')

    # Also save to golden-cage-thesis img folder
    plt.savefig('/Users/hyunjimoon/golden-cage-thesis/img/Ch1_Fig1_funding_paradox.png',
                dpi=300, facecolor='white', bbox_inches='tight')
    plt.savefig('/Users/hyunjimoon/golden-cage-thesis/overleaf_upload/img/Ch1_Fig1_funding_paradox.png',
                dpi=300, facecolor='white', bbox_inches='tight')
